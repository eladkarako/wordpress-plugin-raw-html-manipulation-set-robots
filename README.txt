...
Tags: robots,http header,raw,html,modify,string,manipulation,buffer,php,async,js,headjs,asynchronous,javascript,css,perfor,api,framework,easy,wordpress,developer
Requires at least: 3.0
Tested up to: 4.7
Stable tag: trunk
License: GPLv2 or later

Set ROBOTS Is A Unique Plugin: It Uses A Ruthless HTML-Manipulation At A Level Beyond WordPress-API, To Set ROBOTS Meta (+bonus: HTTP-Headers). There Are No Setting - Feel Free To Edit The Values, If You Want To PREVENT ROBOTS-Access, Just Uncomment The Second-Line, And Comment-Out The Line Above It.
